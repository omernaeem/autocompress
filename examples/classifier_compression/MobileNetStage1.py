...
def run_distiller():
    ...
    os.system(
        "python3 compress_classifier.py -a plain20_cifar " + DATASET_PATH + " -p 30 -j=4 --lr=0.01 --out-dir logs/agp75/ --compress=schedules/temp.yaml  --resume " + resumepath + " --epochs 1 --effective-train-size " + str(
            train_size) + " --effective-valid-size " + str(valid_size) + " --effective-test-size " + str(
